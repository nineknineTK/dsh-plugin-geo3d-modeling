...
const DESCRIPTION =
  '地质三维建模与三维地震资料处理全流程：SEG-Y 数据体解析、层位/断层解释数据解析、CGCS2000 坐标统一（带带号）、原始数据分类整理、断层面建模、断层代表线与勘探范围 shp 输出、多矿区三维地质平台。';
const WHEN_TO_USE =
  '处理 SEG-Y 地震数据体、层位/断层解释文件（UDF/P701/FLT）、勘探范围边界、坐标系转换与带号恢复、生成带坐标系的标准 shp 成果、搭建三维地质展示平台时。';
const INVOCATION = {
  modelInvocable: true,
  userInvocable: true,
};
